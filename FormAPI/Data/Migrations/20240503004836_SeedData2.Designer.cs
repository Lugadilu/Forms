...
namespace FormAPI.Data.Migrations
{
    ...
    [Migration("20240503004836_SeedData2")]
            ...
            modelBuilder.Entity("FormAPI.Models.FormRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "123 Main St",
                            Arrival = new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Attributes = new Dictionary<string, string> { ["Attribute1"] = "Value1", ["Attribute2"] = "Value2" },
                            Birthdate = new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            City = "New oke",
                            Country = "USA",
                            Departure = new DateTime(2024, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 2,
                            Address = "123 Main St",
                            Arrival = new DateTime(2024, 5, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Attributes = new Dictionary<string, string> { ["Attribute1"] = "Value1", ["Attribute2"] = "Value2" },
                            Birthdate = new DateTime(1995, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            City = "Philadephia",
                            Country = "USA",
                            Departure = new DateTime(2024, 5, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
